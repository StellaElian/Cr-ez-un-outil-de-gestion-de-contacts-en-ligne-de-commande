...
class Contact
{
   ...
   public function setPhoneNumber(?string $phoneNumber): self // retourne lui même (à ka fin des setters)
   {
      $this->phoneNumber = $phoneNumber;

      return $this;
   }
   // getter setter ensemble + __toString tout (poprietés, __toString/__Construct puis getter/setter)
